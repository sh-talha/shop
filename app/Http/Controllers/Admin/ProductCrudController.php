...
class ProductCrudController extends CrudController
{
    ...
    public function setFields()
    {
        ...
        $this->crud->addField([
                ...
                'filesize'      => 3, // maximum file size in MB
    ...
    public function createajaxUploadProductImages(Request $request, Product $product)
    {
    ...
    public function store(StoreRequest $request, ProductGroup $productGroup, SpecificPrice $specificPrice)
    {
        ...
        $data = array('user_id'=>$user_info->id, 'price' => $request->price_with_vat);
        
        DB::table('products')->where('sku',$request->sku)->update($data);
    ...
    public function update(UpdateRequest $request, Attribute $attribute, Product $product)
    {
        ...
        Product::where('id',$this->crud->request->id)->update(['price' => $request->price_with_vat]);
