        ...
        <?php if(session('cart')): ?>
            <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td data-th="size"><?php echo e(($details['size'] == '') ? '-':$details['size']); ?></td>
...
<div class="container">
    ...
    <div class="row">
        ...
        <button class="btn btn-warning "><a href="<?php echo e(url('/shop')); ?>" style="color: black" ><i class="fa fa-angle-left"></i> Continue Shopping</a></button>
        </div>
        <div class="col-md-1">
         <button class="btn btn-warning"  id='checkout_btn'>Checkout <i class="fa fa-angle-right"></i></button>
