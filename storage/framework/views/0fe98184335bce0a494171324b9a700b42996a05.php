...
<section class="order_details section_gap" >
    <div class="container">
        ...
        <div class="row" style="background-color: white">
            <div class="col-md-8 order_details_table" style="margin-left:-10px;border-radius: 20px"  >
                <h2>Order Details</h2>
            ...
            <div class="col-md-4 order_details_table" style="margin-left:10px;border-radius: 20px;background-color: #92E588;color: white" >
                <h2>Card Details</h2>
                ...
                <form role="form" action="<?php echo e(route('stripe.post')); ?>" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e(env('STRIPE_KEY')); ?>" id="payment-form">
                    ...
                    <div class='form-row row'>
                        ...
                        <div class="col-xs-12">
                            <button class="btn btn-warning float-right" type="submit">Pay Now </button>
                        </div>
                    </div>
            </div>
        </div>
