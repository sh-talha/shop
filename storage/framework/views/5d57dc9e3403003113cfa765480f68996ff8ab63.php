	...
	<div class="col-lg-4 col-md-8 single-item">
	    <div class="single-product img-thumbnail">
	       <a href="<?php echo e(url(app()->getLocale().'/product/'.$product->Products_id)); ?>" class="social-info">
	        <img class="img-fluid  filter_image_size" src="<?php echo e(asset('uploads/products/'.substr($product->Products_id, 0, 1).'/'.$product->Products_id.'/'.$product->product_image)); ?>" alt="" > </a>
	        <hr>
