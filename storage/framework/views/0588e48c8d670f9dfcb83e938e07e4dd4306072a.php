...
?>
                      <?php if($special != 0): ?>
                        ...
                        <a onclick="Special_price_button(<?php echo e($viewproduct->product_id); ?>)" class="btn btn-xs btn-default"><i class="fa fa-trash"></i> Delete Special Price</a>
    ...
    function Special_price_button($id){
        ...
        swal({
          ...
          setTimeout(function () {
             ...
             var delete_id = $id
              $.get('<?php echo e(url('admin/deletespecialprice')); ?>',
                 {
...
<script type="text/javascript">
  ...
  $('#Editvendor').click(function(event) {
    ...
    if(editid == <?php echo e($viewproduct->product_id); ?>){
