  ...
  <br>
    ...
    <table id="cart" class="table table-hover table-condensed table-responsive">
        ...
        <tr>
            ...
            <td class="hidden-xs text-center"><strong>Total <?php echo e($total); ?> &euro;</strong></td>
            <td colspan="1" class="hidden-xs"></td>
...
<div class="container">
    ...
    <div class="row  mb-3">
        ...
        <button class="btn btn-warning "><a href="<?php echo e(route('shop',app()->getLocale())); ?>" style="color: black" ><i class="fa fa-angle-left"></i> <?php echo e(__('base.continue_shopping')); ?></a></button>
  <button class="btn btn-warning float-right"  id='checkout_btn'><?php echo e(__('base.realizar')); ?> <i class="fa fa-angle-right"></i></button>
        </div>
