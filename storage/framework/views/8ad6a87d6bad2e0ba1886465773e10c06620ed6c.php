					...
					<form method="get">
						...
						<div class="s_product_text">
							...
							<div class="row">
								...
								<?php else: ?>
									<div class="col-md-4">
										<h2>$<?php echo e($special); ?></h2>
									</div>
									<div class="col-md-4">
										<s><h2>$<?php echo e($products->price); ?></h2></s>
									</div>
								<?php endif; ?>
							...
							<p id="description_p"><?php echo e($products->description); ?></p>
							...
							<div class="col-md-8" style="margin-left: -14px">
								...
								<div class="row">
									...
									<div class="col-md-4 class_img_vendor_active " id="active_<?php echo e($viewproducts_vendor->vendo_product_id); ?>">
										
									<img class="img-fluid img-thumbnail img_class_hide class_img_vendor"src="
									<?php echo e(asset(Storage::url('upload/vendor_products/'.$viewproducts_vendor->image))); ?>" alt="" style="width: 100px;display: nones" id="item_img_<?php echo e($viewproducts_vendor->vendo_product_id); ?>">
									</div>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							...
							<div class="col-md-8" style="margin-left: -14px"><br>
								...
								<div class="row" style="margin-left: 2px">
									<?php $__currentLoopData = $color; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $viewcolor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="col-md-3 img-thumbnail class_size_vendor" style="margin-right: 10px;margin-top: 10px" id="<?php echo e($viewcolor->value); ?>">
										<span ><?php echo e($viewcolor->value); ?><br></span>
							...
							<div class="card_area d-flex align-items-center "><br><br>
								<a class="primary-btn cart_class_s " id="<?php echo e($products->Products_id); ?>">Add</a>
