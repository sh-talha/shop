                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto" id="main-menu-navigation">
                            ...
                            <li class="nav-item">
                                <div class="dropdown" id="cart_id" >
                                    ...
                                    <div class="dropdown-menu" style="width:300px;margin-left: -120px" >
                                        <div class="row total-header-section">
                                            <div class="col-lg-6 col-sm-6 col-md-12">
                                                <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="badge badge-pill badge-danger"><?php echo e(session('cart')!=null?count(session('cart')):0); ?></span>
                                            </div>
                                            <?php $total = 0 ?>
