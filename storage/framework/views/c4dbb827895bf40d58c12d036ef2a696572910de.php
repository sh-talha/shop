  <div class="form-group col-md-12 attr-field attr-type-media image" style="display: none;" data-preview="#<?php echo e($field['name']); ?>" data-aspectRatio="<?php echo e(isset($field['aspect_ratio']) ? $field['aspect_ratio'] : 0); ?>" data-crop="<?php echo e(isset($field['crop']) ? $field['crop'] : false); ?>" <?php echo $__env->make('crud::inc.field_wrapper_attributes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>>
    <div>
    ...
    <div class="row">
        <div class="col-sm-6" style="margin-bottom: 20px;">
            ...
            <?php if(isset($entry) && count($entry->values) > 0): ?>
                <img id="mainImage" src="<?php echo e(url(config('filesystems.disks.'.(isset($field['disk']) ? $field['disk'] : 'local').'.simple_path').'/'.$entry->values->first()->value)); ?>">
            <?php else: ?>
                <img id="mainImage" src="<?php echo e(old($field['name']) ? old($field['name']) : (isset($field['value']) ? $field['value'] : (isset($field['default']) && Storage::disk('attributes')->has($field['default'])) ? url(config('filesystems.disks.'.(isset($field['disk']) ? $field['disk'] : 'local').'.simple_path').'/'.$field['default']) : '')); ?>">
            <?php endif; ?>
        </div>
