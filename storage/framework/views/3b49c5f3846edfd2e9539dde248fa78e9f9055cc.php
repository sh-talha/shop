...
<!-- Default box -->
  ...
  <?php if(Route::is('crud.products.index')): ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('clone_product')): ?>
      <div class="clone-product-modal modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="<?php echo e(trans('common.close')); ?>"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><i class="fa fa-clone"></i> <?php echo e(trans('product.clone_product')); ?></h4>
            </div>
            <form action="<?php echo e(route('clone.product')); ?>" method="POST">
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      <label><?php echo e(trans('product.cloned_product_sku')); ?></label>
                      <input type="text" class="form-control" name="clone_sku" required="true">
                      <span><?php echo e(trans('common.must_be_unique')); ?></span>
                    </div>
                    ...
                    <div class="form-group col-md-12">
                      <div class="checkbox">
                        <label>
                          ...
                          <?php echo e(trans('product.clone_images')); ?>

                        </label>
                      </div>
                      <span><?php echo e(trans('product.clone_images_hint')); ?></span>
                    </div>                    
                  </div> 
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('common.cancel')); ?></button>
                  <button type="submit" class="btn btn-primary"><?php echo e(trans('product.clone')); ?></button>
                </div>
            </form>
          </div>
        </div>
...
<?php $__env->startSection('after_scripts'); ?>
	...
	swal({
		title: "<?php echo e(trans('backpack::crud.are_you_sure')); ?>",
		text: "<?php echo e(trans('backpack::crud.delete_confirm')); ?>",
		type: "warning",
		showCancelButton: true,
		confirmButtonColor: "#3C8DBC",
		confirmButtonText: "<?php echo e(trans('backpack::crud.confirm_delete')); ?>",
		...
		if (isConfirm) {
		    ...
		    swal("<?php echo e(trans('backpack::crud.delete_confirmation_title')); ?>", "<?php echo e(trans('backpack::crud.delete_confirmation_message')); ?>", "success");
		} else {
		    swal("<?php echo e(trans('backpack::crud.delete_confirmation_not_deleted_title')); ?>", "<?php echo e(trans('backpack::crud.delete_confirmation_not_deleted_message')); ?>", "error");
		}
	    });
        });
      }
