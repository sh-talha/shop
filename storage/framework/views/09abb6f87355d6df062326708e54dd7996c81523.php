...
<div class="navbar-custom-menu">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(url('')); ?>/admin/Order" class="text-capitalize">Order</a></li>
                    ...
                    <tbody>
                     <?php $__currentLoopData = $order_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view_order_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr role="row" class="odd">
                         <td><?php echo e($view_order_details->tracking_id); ?></td>
                         <td><?php echo e($view_order_details->productname); ?></td>
                         <td><?php echo e($view_order_details->price); ?></td>
                         <td><?php echo e(($view_order_details->color == '')? '-':$view_order_details->color); ?></td>
                         <td><?php echo e(($view_order_details->size == '')? '-':$view_order_details->size); ?></td>
                         <td><?php echo e($view_order_details->quantity); ?></td>
                         <td><?php echo e($view_order_details->total_price); ?></td>
                         <td><?php echo e($view_order_details->countries.' , '.$view_order_details->state.' , '.$view_order_details->add1); ?></td>
                         <td><?php echo e($view_order_details->date); ?></td>
                ...
                <?php else: ?>
                  ...
                  <thead>
                    ...
                    <tbody>
                     <?php $__currentLoopData = $order_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view_order_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr role="row" class="odd">
                         <td><?php echo e($view_order_details->username); ?></td>
                         <td><?php echo e($view_order_details->tracking_id); ?></td>
                         <td><?php echo e($view_order_details->status); ?></td>
                         <td><?php echo e($view_order_details->total_price); ?></td>
                         <td><?php echo e($view_order_details->date); ?></td>
                         <td><a href="<?php echo e(url('admin/orders/'.$view_order_details->tracking_id)); ?>" class="btn btn-xs btn-default "><i class="fa fa-eye"></i> View</a>      </td>
                       </tr>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
