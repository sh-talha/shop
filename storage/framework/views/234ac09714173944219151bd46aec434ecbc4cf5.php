            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6"  id="cart_id_<?php echo e($view_wish->Products_id); ?>">
                    <div class="single-product img-thumbnail">
                       <img class="img-fluid img-thumbnail filter_image_size" src="uploads/products/<?php echo e(substr($view_wish->Products_id, 0, 1)); ?>/<?php echo e($view_wish->Products_id); ?>/<?php echo e($view_wish->product_image); ?>" >
