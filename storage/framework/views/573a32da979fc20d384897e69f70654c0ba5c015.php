    ...
    <div class="row">
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
            ...
            <div class="filter-bar d-flex flex-wrap align-items-center" >
               <input id="filter" type="text" class="form-control col-md-3 " placeholder="Search">
               <br><br>
                  ...
                  <div class="product_container" id="cat_filter_product">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12  single-item results">
                        <div class="single-product img-thumbnail ">
                           <img class="img-fluid img-thumbnail filter_image_size" src="<?php echo e(asset('uploads/products/'.substr($product->Products_id, 0, 1).'/'.$product->Products_id.'/'.$product->product_image)); ?>" alt="" >

                            <div class="product-details">
                                <h6><?php echo e($product->product_name); ?></h6>
                                <div class="price">
                                    <h6><?php echo e($product->price); ?></h6>
                                    <h6 class="l-through">$22</h6>
                                </div>
