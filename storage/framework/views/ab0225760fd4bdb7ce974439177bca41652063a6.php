					...
					<div class="login_form_inner">
						...
						<form class="row login_form " method="POST" action="<?php echo e(route('login')); ?>" id="contactForm" novalidate="novalidate">
							...
							<div class="form-group">
							    <input id="email" type="email" class="form-control " name="email"  required autofocus value="admin@ecommerce.com">
							...
							<div class="col-md-12 form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
							    ...
							    <div class="">
							        <input id="password" type="password" class="form-control" value="adminpass" name="password" required>
