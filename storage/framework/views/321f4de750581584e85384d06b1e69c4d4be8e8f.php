...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon-->
    <link rel="shortcut icon" href="<?php echo e(url('img/fav.png')); ?>">
    <!-- Author Meta -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light main_box">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('img/logo.png')); ?>" alt=""></a>
                 ...
                 <div class="d-block d-sm-none">  <a href="<?php echo e(route('cart',app()->getLocale())); ?>" 
                                   id="product_cart_list"><i class="fa fa-shopping-cart" aria-hidden="true"
                                       style="color:#68c55b"></i>  <span
                                            class="badge badge-pill badge-danger"><?php echo e(session('cart')!=null?count(session('cart')):0); ?></span></a></div>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto" id="main-menu-navigation">
                        <li class="nav-item"><a class="nav-link"
                                                href="<?php echo e(route('home',app()->getLocale())); ?>"><?php echo app('translator')->getFromJson('base.home'); ?></a>
                        </li>
                        <li class="nav-item submenu dropdown">
                            <a href="<?php echo e(route('shop',app()->getLocale())); ?>"
                               class="nav-link dropdown-toggle"><?php echo app('translator')->getFromJson('base.shop'); ?></a>
                        </li>


                        <?php if(session()->get('Role_id.role_id') == 3): ?>
                            <li class="nav-item"><a class="nav-link"
                                                    href="<?php echo e(route('myaccount',app()->getLocale())); ?>"><?php echo app('translator')->getFromJson('base.my_account'); ?></a>
                            </li>

                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('logout',app()->getLocale())); ?>"
                                                    onclick="event.preventDefault();

                             document.getElementById('logout-form').submit();"><?php echo app('translator')->getFromJson('base.logout'); ?></a>
                            </li>
                            <form id="logout-form" action="<?php echo e(route('logout',app()->getLocale())); ?>" method="POST"
                                  style="display: none;">
                        ...
                        <?php else: ?>
                            <li class="nav-item"><a class="nav-link"
                                                    href="<?php echo e(route('logins',app()->getLocale())); ?>"><?php echo app('translator')->getFromJson('base.login'); ?></a>
                            </li>
                        ...
                        <li class="nav-item dropdown" style="top:10px;">
                            <a style="color: #222222;" href="#" class="dropdown-toggle" data-toggle="dropdown"
                               role="button" aria-expanded="false" aria-haspopup="true">
                                <?php echo app('translator')->getFromJson('base.language'); ?>
                            </a>
                        ...
                        <li class="nav-item">
                            <?php if(session('cart')): ?>
                               <a href="<?php echo e(route('cart',app()->getLocale())); ?>" class="btn btn-primary btn-block"
                                   style="display:none; background: linear-gradient(90deg, #ffba00 0%, #ff6c00 100%); "
                                   id="product_cart_list"><i class="fa fa-shopping-cart" aria-hidden="true"
                                       style="color:#68c55b"></i> <?php echo app('translator')->getFromJson('base.cart'); ?> <span
                                            class="badge badge-pill badge-danger"><?php echo e(session('cart')!=null?count(session('cart')):0); ?></span></a>
                            <?php endif; ?>
                            ...
                            <div class="dropdown" id="cart_id">
                                <button type="button" class="btn btn-info" data-toggle="dropdown"
                                    ...
                                    <i class="fa fa-shopping-cart" aria-hidden="true"
                                       style="color:#68c55b"></i> <?php echo app('translator')->getFromJson('base.cart'); ?> <span
                                            class="badge badge-pill badge-danger"><?php echo e(session('cart')!=null?count(session('cart')):0); ?></span>
                                </button>
                                <div class="dropdown-menu drop_cart">
                                    <div class="row total-header-section">
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-6 total-section text-right cart_align">
                                            <p>Total: <span class="text-info"> <?php echo e($total); ?> &euro;</span></p>
                                        </div>
                                    </div>
                                    <hr>
                                                ...
                                                <div class="row cart-detail">
                                                    <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                                                        <?php if($details["color"] == ''): ?>
                                                            <img src="<?php echo e(asset('uploads/products/'.substr($details["p_id"], 0, 1).'/'.$details["p_id"].'/'.$details["photo"])); ?>"
                                                                 width="60" height="60" class="img-responsive"
                                                                 style="padding: 5px"/>
                                                        <?php else: ?>
                                                            <img src="<?php echo e($details['photo']); ?>" width="60" height="60"
                                                                 class="img-responsive" style="padding: 5px"/>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
                                                        <span><?php echo e($details['name']); ?></span><br>
                                                        <span class="price text-info">  <?php echo e($details['price']); ?> &euro;</span><br>
                                    ...
                                    <div class="container">
                                        <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                                            <a href="<?php echo e(url(app()->getLocale().'/cart')); ?>"
                                               ...
                                               style="background: linear-gradient(90deg, #ffba00 0%, #ff6c00 100%); "><?php echo e(__('base.view_all')); ?></a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4  col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6><?php echo e(__('base.contact_us')); ?></h6>
                    <form>
                        <div class="form-group">
                            <input type="text" class="form-control col-md-9" id="contactname"
                                   aria-describedby="emailHelp" placeholder="<?php echo e(__('base.enter_name')); ?>">

                        </div>
                        <div class="form-group ">
                            <input type="email" class="form-control col-md-9" id="contactemail"
                                   placeholder="<?php echo e(__('base.email')); ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" style="display: none" id="errorfield">
                            <div class="alert alert-warning col-md-9" role="alert">
                                <?php echo e(__('base.footer_form_error')); ?>

                            </div>
                        </div>

                        <button type="button" id="contactform" class="btn btn-success"><?php echo e(__('base.submit')); ?></button>
                    </form>
                </div>
            </div>
            <div class="col-lg-4  col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6><?php echo e(__('base.others')); ?></h6>

                    <p>
                        <a href="<?php echo e(route('selleraccount',app()->getLocale())); ?>">
                            卖方账户</a>
                    </p>
                    <p>
                        <a href="<?php echo e(route('termandcondition',app()->getLocale())); ?>"><?php echo e(__('base.term_conditions')); ?></a>
                    </p>
                    <p>
                        <a href="<?php echo e(route('privacy',app()->getLocale())); ?>"><?php echo e(__('base.privacy')); ?></a>
                    </p>
                    <p>
                        <a href="<?php echo e(route('termandcondition#report',app()->getLocale())); ?>"><?php echo e(__('base.term_text')); ?></a>
                    </p>

                    <li class="nav-item submenu dropdown">
                        <a href="<?php echo e(route('aboutus',app()->getLocale())); ?>"
                           class="nav-link dropdown-toggle"><?php echo app('translator')->getFromJson('base.about_us'); ?></a>
                    </li>
                    <li class="nav-item submenu dropdown">
                        <a href="<?php echo e(route('faq',app()->getLocale())); ?>"
                           class="nav-link dropdown-toggle"><?php echo app('translator')->getFromJson('base.faq'); ?></a>
                    </li>
            ...
            <div class="col-lg-4  col-md-6 col-sm-6">
                <div class="single-footer-widget mail-chimp">
                    <h6 class="mb-20"><?php echo e(__('base.instragram_feed')); ?></h6>
        ...
        <div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
            <p class="footer-text m-0">
                @ GRANYUPON.COM <?php echo e(__('base.copy_rights')); ?> &copy;
                <script>
                    document.write(new Date().getFullYear());
                </script> <?php echo e(__('base.rights')); ?> |
            </p>
        </div>
    </div>
</footer>
...
<script type="text/javascript">
    ...
    function OrderView(trackingid, orderid) {
        ...
        $.get('<?php echo e(url(app()->getLocale().'/orderdetails')); ?>',
            {
    ...
    function disputeorder(trackingid, orderid) {
        ...
        swal({
            ...
            setTimeout(function () {
                ...
                $.post('<?php echo e(url(app()->getLocale().'/orderdispute')); ?>',
                    {
                        _token: "<?php echo e(csrf_token()); ?>",
                        orderid: order_id,
                    ...
                    function (data) {
                        window.location.href = '<?php echo e(url(app()->getLocale()."/order")); ?>';
                        // alert(data);
                        // // $('#order_details').modal('show');
                        // // $('#order_details_product').html(data);
                        // // 
    ...
    $(document).ready(function () {
        ...
        $('#contactform').click(function (event) {
            ...
            if (name != '' && email != '' && text != '') {
                ...
                $.get('<?php echo e(url(app()->getLocale().'/contact')); ?>', {
                        name: name,
                        email: email,
                        text: text
                    },
        ...
        $('#checkout_btn').click(function (event) {
            ...
            window.location.href = '<?php echo e(route('checkout',app()->getLocale())); ?>';
            <?php else: ?>
                   swal({
...
function(){
  window.location = "https://granyupon.com/es/registration";
        ...
        $('.report_class').click(function (event) {
                    ...
                    <?php if(Auth::id() !=null): ?>
            var ids = $(this).attr('id');
            $.get('<?php echo e(url(app()->getLocale().'/report-product')); ?>',
                {
                    _token: "<?php echo e(csrf_token()); ?>",
                    productid: ids,
...
function(){
  window.location = "https://granyupon.com/es/registration";
        ...
        $('.class_cat_name').click(function (event) {
            ...
            $.get('<?php echo e(url(app()->getLocale().'/catfilter')); ?>',
                {
                    _token: "<?php echo e(csrf_token()); ?>",
                    catid: id,
                    offerCheck: '<?php echo e(Request::get('offer')); ?>',
                    sort_by: '<?php echo e(Request::get('sort_by')); ?>',
                },
                function (data) {
                    ...
                    if ('<?php echo e(Request::get('offer')); ?>' == '') {
        ...
        $('.filter_class').click(function (event) {
            ...
            // alert(higherprice);
            $.get('<?php echo e(url(app()->getLocale().'/filterprice')); ?>', {
                    _token: $('input[name=_token]').val(),
...
<?php if(Session::has('OrderNo')): ?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Order Completed Successfully! <br> Thank you! Your purchase is complete and Your tracking id is <b><?php echo e(Session::get('OrderNo')); ?></b>.
          </div>
    ...
    <script type="text/javascript">
        // $('#order_no').modal('show');
          swal(" Pedido completado con éxito!!", "Thank you! Your purchase is complete and Your tracking id is <?php echo e(Session::get('OrderNo')); ?>", "success");
    </script>
            ...
            <div class="modal-body">
                <div class="box-body box-profile">
                        ...
                        <?php if(Auth::user() !=null): ?>
                            <?php if(Auth::user()->image == null): ?>
                                <img id="ShowImage" class=" img-responsive rounded"
                                     src="<?php echo e(asset(Storage::url("app/public/upload/user_image/default.png"))); ?>">
                            <?php else: ?>
                                <img id="ShowImage" class=" img-responsive rounded"
                                     src="<?php echo e(asset(Storage::url("app/public/upload/user_image/".Auth::user()->image))); ?>">
                    ...
                    <div class="text-center">
                        <form method="post" enctype="multipart/form-data" action="<?php echo e(url('edit-image')); ?>"
