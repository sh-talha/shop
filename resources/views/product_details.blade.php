				...
				<div class="col-lg-5 offset-lg-1">
					<form method="get">
						...
						<div class="s_product_text" style="margin-top:5px;">
							...
							{{-- <h2>{{  number_format($products->price,2) }} &euro;</h2> --}}
							<div class="row">
								...
								@else
									...
									<div class="col-md-4">
										<s><h2>{{ number_format($products->price,2) }} &euro;</h2></s>
									</div>
								@endif
							...
							<ul class="list">
							    	...
							    	<h6><span>{{$overall}} </span> ({{$total_review_count}} Reviews)<span style="
    color: #ffe907;
">
								...
								<li><a href="#"><span>{{ __('shop.availibility')}}</span> : {{($products->price > 0) ? 'In Stock' : 'Out of Stock' }}</a></li>
							</ul>
							<p id="description_p" style="margin-bottom: 5px;">{{$products->description}}</p>
						
							@if($vendor_count != null)
							<div class="product_count" style="margin-top: -50px;display: none">
								<label for="color"><b>{{ __('shop.color')}}:</b></label>
							...
							<div class="product_count">
								<label for="qty"> {{ __('shop.quantity')}}:</label>
...
Así que pide el tuyo cuanto antes.</block>
    ...
    max-width: 24.333333%; border-radius:50%;" class="col-md-4 class_img_vendor_active " id="active_{{$viewproducts_vendor->vendo_product_id}}">
										
									<img style="align-items: center; border-radius:50%;" class="img-fluid img-thumbnail img_class_hide class_img_vendor"src="
									{{ asset(Storage::url('upload/vendor_products/'.$viewproducts_vendor->image))}}" alt="" style="width: 80px;display: nones" id="item_img_{{$viewproducts_vendor->vendo_product_id}}">
									</div>
									@endforeach
						...
						@endphp 
								...
								<label for="size"><b>{{ __('shop.size')}}:</b></label>
								<select name="size" class="form-control" id="size">
									<option value="0">Select Size</option>
									@foreach($sizes as $size)
					                 	<option value="{{ str_replace(' ', '-',$size->pivot->value)}}">{{$size->pivot->value}}</option>
					              	 @endforeach
							...
							<div class="col-md-8" style="margin-left: -14px"><br>
								<label for="qty">{{ __('shop.size')}}:</label>
								<div class="row" style="margin-left: 2px">
									@foreach($sizes as $size)
									<div class="col-md-3 img-thumbnail class_size_vendor" style="margin-right: 10px;margin-top: 10px" id="{{ str_replace(' ', '-',$size->pivot->value)}}">
										<span >{{$size->pivot->value}}<br></span>
							...
							<div class="card_area d-flex align-items-center "><br><br>
								<a class="primary-btn cart_class_s " id="{{$products->Products_id}}">{{ __('shop.add')}}</a>

								<a class="btn btn-light report_class" id="{{$products->Products_id}}">{{ __('shop.report')}}</a>
	...
	<section class="product_description_area">
		<div class="container">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item">
					<a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">{{ __('shop.description')}}</a>
				</li>
				{{-- <li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
					 aria-selected="false">{{ __('shop.comments')}}</a>
				</li> --}}
				<li class="nav-item">
					<a class="nav-link active" id="review-tab" data-toggle="tab" href="#review" role="tab" aria-controls="review"
					 aria-selected="false">{{ __('shop.reviews')}}</a>
				</li>
			</ul>
			<div class="tab-content" id="myTabContent">
							...
							<div class="review_box">
								...
								<form class="row contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
									...
									<div class="col-md-12 text-right">
										<button type="submit" value="submit" class="btn primary-btn">{{ __('shop.submit_now')}}</button>
									</div>
								</form>
							</div>
						</div>
				...
				<div class="tab-pane fade show active" id="review" role="tabpanel" aria-labelledby="review-tab">
					<div class="row">
						<div class="col-lg-6">
							<div class="row total_rate">
								...
								<div class="col-6">
									<div class="rating_list">
										<h3>{{ __('shop.based_on')}} {{$total_review_count}} {{ __('shop.reviews')}}</h3>
										<ul class="list">
											<li>
												<a href="#">5 Star 
													<i class="fa fa-star"></i>
							...
							<div class="review_list">
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											@if($view_reviews->image !=null )
												<img src="{{ asset(Storage::url("upload/user_image/".$view_reviews->image))}}" alt="" width="55px" height="55px" class="rounded-circle" >
											@else
												<img src="{{ asset(Storage::url("upload/user_image/default.png"))}}" alt="" width="55px"  height="55px" class="rounded-circle">
											@endif
										</div>
										<div class="media-body">
									...
									<a class="image-popup-no-margins" href="{{ asset(Storage::url("upload/reviews_images/".$view_reviews->image_1))}}">	<img src="{{ asset(Storage::url("upload/reviews_images/".$view_reviews->image_1))}}" class="img-responsive img-rounded img-thumbnail" style="width:120px" /></a>
										@endif
										@if($view_reviews->image_2 != null)
									<a class="image-popup-no-margins"href="{{ asset(Storage::url("upload/reviews_images/".$view_reviews->image_2))}}">	<img src="{{ asset(Storage::url("upload/reviews_images/".$view_reviews->image_2))}}" class="img-responsive img-rounded img-thumbnail" style="width:120px" /></a>
										@endif
										@if($view_reviews->image_3 != null)
											<a class="image-popup-no-margins" href="{{ asset(Storage::url("upload/reviews_images/".$view_reviews->image_3))}}"> <img src="{{ asset(Storage::url("upload/reviews_images/".$view_reviews->image_3))}}" class="img-responsive img-rounded img-thumbnail" style="width:120px" /></a>
										@endif
									</div>
								</div>
								@endforeach
						...
						<div class="col-lg-6">
							<div class="review_box">
								<h4 style="padding-top:10px; margin-right:-15px;" >{{ __('shop.add_review')}}</h4>
								<form class="row contact_form" action="{{url(app()->getLocale().'/add-review')}}" method="post" id="contactForm"
								...
								>
									...
									<div class="col-md-12 text-right">
										@if(Auth::id() !=null)
											<button type="submit" id="submit_form" value="submit" class="primary-btn" style="display: none">{{ __('shop.submit_now11')}}</button>
											<button type="button" value="submit" class="primary-btn" id="product_review_id" >{{ __('shop.submit_now11')}}</button>
										
										@else
										<button type="button" onclick="ErrorAlert()" class="primary-btn">{{ __('shop.submit_now11')}}</button>
										@endif
									</div>
								</form>
