        ...
        <div class="user-panel">
          <div class="pull-left image">
            ...
            @if(Auth::user()->image == null)
              <img src="{{ asset(Storage::url("upload/user_image/default.png"))}}" alt="" style="width: 70px;height: 70px"  class="img-circle">
            @else
              <img src="{{ asset(Storage::url("upload/user_image/".Auth::user()->image))}}" alt="" style="width: 70px;height: 70px" class=" img-circle">
            @endif
          ...
          <div class="pull-left info">
            <p>{{ Auth::user()->name }}</p>
            <small><small><a href="{{ url('admin/edit-account') }}"><span><i class="fa fa-user-circle-o"></i> {{ trans('backpack::base.my_account') }}</span></a> &nbsp;  &nbsp; <a href="{{ backpack_url('logout') }}"><i class="fa fa-sign-out"></i> <span>{{ trans('backpack::base.logout') }}</span></a></small></small>
          </div>
        </div>
...
{{--
        ...
        {{--   @can('list_cart_rules')
          ...
          @if(Auth::user()->roles[0]->pivot->role_id == 1)
            <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/seller') }}">
