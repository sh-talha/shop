...
<div class="navbar-custom-menu">
      ...
      <!-- =============================================== -->
       ...
       <!-- =============================================== -->
         ...
         <ol class="breadcrumb">
             ...
             <li>
                 <a href="{{url('')}}/admin"> Granyupon</a>
             </li>

             <li>
                 <a href="{{url('')}}/admin/edit-account-info">My Account</a>
             </li>
    ...
    <section class="content">
        ...
        <div class="col-md-3">
            <div class="box">
               <div class="box-body box-profile">
                ...
                <img class="profile-user-img img-responsive img-circle" src="{{ asset(Storage::url("upload/user_image/default.png"))}}">
                @else 
                <img class="profile-user-img img-responsive img-circle" src="{{ asset(Storage::url("upload/user_image/".Auth::user()->image))}}">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li role="presentation"
                      class="active"
                        ><a href="{{url('')}}/admin/edit-account">Update Account Info</a></li>
      ...
      <div class="col-md-6">
         <form class="form" action="{{url('admin/editprofiledata')}}" method="post">
         ...
         <div class="box">
             ...
             <div class="box-body backpack-profile-form">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control " name="country" id="countries" >
                       @foreach($countries as $view_countries)
                        <option {{( Auth::user()->country == $view_countries->id ) ? 'selected':'' }} value="{{$view_countries->id}}">{{$view_countries->name}}</option>
                       @endforeach
                    </select>
                 </div>
                  <div class="form-group">
                    ...
                    <div id="state">
                     <select class="form-control disable" name="city" >
                         @foreach($state as $view_state)
                              <option {{( Auth::user()->city == $view_state->id ) ? 'selected':'' }} value="{{$view_state->id}}">{{$view_state->name}}</option>
                         @endforeach
                     </select>
              ...
              @if(Auth::user()->roles[0]->pivot->role_id != 1)
                  ...
                  <label class="required">bank</label>
                    <input class="form-control" type="text" name="bank" value="{{Auth::user()->bank}}">
                  </div>
                   <div class="form-group">
                  <label class="required">Iban No</label>
                    <input class="form-control" type="text" name="ibanno" value="{{Auth::user()->ibanno}}">
                  </div>
                  ...
                  ><label class="required">Seller</label>
                    <select class="form-control" name="typeseller">
                      <option value="0" {{(Auth::user()->typeseller == 0 )? 'selected':''}}>Private Seller</option>
                      <option value="1" {{(Auth::user()->typeseller == 1 )? 'selected':''}}>Company</option>
                    </select>
                  </div>
                  @endif
             </div>
             ...
             <div class="box-footer">
                 ...
                 <a href="{{url('')}}/admin" class="btn btn-default"><span class="ladda-label">Cancel</span></a>
