...
<div class="navbar-custom-menu">
    ...
    <h1>
      ...
      <small>All  <span>Order</span> in the database.</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{url('')}}/admin/dashboard">Admin</a></li>
      <li><a href="{{url('')}}/admin/Order" class="text-capitalize">Order</a></li>
                    ...
                    <tbody>
                     @foreach($order_details as $view_order_details)
                       <tr role="row" class="odd">
                         <td>{{$view_order_details->tracking_id}}</td>
                         <td>{{$view_order_details->productname}}</td>
                         <td>{{$view_order_details->price}}</td>
                         <td>{{($view_order_details->color == '')? '-':$view_order_details->color}}</td>
                         <td>{{($view_order_details->size == '')? '-':$view_order_details->size}}</td>
                         <td>{{$view_order_details->quantity}}</td>
                         <td>{{$view_order_details->total_price}}</td>
                         <td>{{$view_order_details->countries.' , '.$view_order_details->state.' , '.$view_order_details->add1}}</td>
                         <td>{{$view_order_details->date}}</td>
                ...
                @else
                  ...
                  <thead>
                    ...
                    <tbody>
                     @foreach($order_details as $view_order_details)
                       <tr role="row" class="odd">
                         <td>{{$view_order_details->username}}</td>
                         <td>{{$view_order_details->tracking_id}}</td>
                         <td>{{$view_order_details->status}}</td>
                         <td>{{$view_order_details->total_price}}</td>
                         <td>{{$view_order_details->date}}</td>
                         <td><a href="{{ url('admin/orders/'.$view_order_details->tracking_id)}}" class="btn btn-xs btn-default "><i class="fa fa-eye"></i> View</a>      </td>
                       </tr>
                     @endforeach
