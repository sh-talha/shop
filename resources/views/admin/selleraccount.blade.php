...
<div class="navbar-custom-menu">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('')}}/admin/products" class="text-capitalize">Seller</a></li>
           ...
           <div class="box">
             ...
             <table id="crudTable" class="table table-bordered table-striped display">
                 <thead>
                   ...
                   <tbody>
                     @foreach($rep_count as $viewreportinfo)
                     <tr role="row" class="odd">
                       <td>{{$viewreportinfo['sellersinfo']->seller_id}}</td>
                       <td>{{$viewreportinfo['sellersinfo']->name}}</td>
                       <td>$ {{$viewreportinfo['sales']}}</td>
                       <td>{{$viewreportinfo['product_dispute']}}</td>
                       <td>{{$viewreportinfo['report_count']}}</td>
                       <td>{{($viewreportinfo['sellersinfo']->status == 1)? 'Active' :'Inactive' }}</td>

                       {{-- <td>{{$viewreportinfo->sellersinfo->seller_id}}</td> --}}
                       {{-- <td>{{$rep_count}}</td> --}}
                      {{--  <td>{{$viewreportinfo->sku}}</td>
                       <td>{{$viewreportinfo->price}}</td>
                       <td>{{$viewreportinfo->price}}</td>
                       <td>{{$viewreportinfo->stock}}</td>
                       <td>{{($viewreportinfo->active ==1)? 'Active':'Inactive'}}</td>
                       --}}
                     @endforeach
                   </tbody>
                   <tfoot>
